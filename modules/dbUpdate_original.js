		...
		files.forEach(function(file){
			...
			var ignoreFileReg = /.DS_Store/ig
				if(!filenameReg.exec(file) && !ignoreFileReg.exec(file)){
					...
					console.log("The file name being processed: " + logPath);
					...
					read(logPath, function(teciLines) { //Read file line by line and store into teciline without end of sentence
						...
						for(var i in cellCalib)	{
							//console.log('site: ' + cellCalib[i].cellId);
							//console.log('bin: ' + + cellCalib[i].bin);
